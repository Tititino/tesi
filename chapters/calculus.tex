...
% TODO: expand
Figure \ref{fig:hp calculus} shows the calculus of \cite{HarlandPym} using our notation of explicit constraints implementing the ``lazy'' strategy.
...
%			\LeftLabel{$[\llwith]$}
%			\BIC{$\async{\Psi}{\Delta[\mathV'']}{\phi_1 \llwith \phi_2, \Gamma[\mathV'']}$}
%			or equivalently 
%			\AXC{$\async{\Psi}{\Delta[\mathV']}{\phi_2, \Gamma[\mathV']}$}
%			\AXC{$\async{\Psi}{\Delta[\mathV'']}{\phi_1, \Gamma[\mathV'']}$}
%			\LeftLabel{$[\llwith]$}
%			\BIC{$\async{\Psi}{\Delta[\mathV']}{\phi_1 \llwith \phi_2, \Gamma[\mathV']}$}
%			\DP
