...
\begin{figure}[h!]
	\begin{subfigure}{\textwidth}
		\centering
			...
			\\
			\SetCell[c=2]{c} {\footnotesize
			\AXC{$\async{\Psi}{\Delta}{\af{\phi_2}{e}, \Phi} \separator \constr{\used{e}, \Lambda}{\mathV'}$}
			\AXC{$\async{\Psi}{\Delta}{\af{\phi_1}{e}, \Phi} \separator \constr{\used{e}, \Lambda}{\mathV''}$}
...
\begin{figure}[h!]
	...
	\begin{subfigure}{\textwidth}
		...
		\begin{tblr}{ colspec = { cc } 
			...
			\SetCell[c=2]{c} {\footnotesize
			\AXC{$ \new{X} \hspace{.3cm} 
				\focus{\Psi}{\Delta_L^X}{\af{\phi_1}{e}} \separator \constr{\used{e}, \Lambda}{\mathV'} \hspace{.3cm} 
...
\begin{proof}
	...
	\begin{itemize}
		\indCase{\displayten} Given the rule \derRule{\displayten}, we apply the inductive hypothesis, and from the premises 
			...
			should be mapped to.
		\indCase{\displaywith} missing % Given the rule \derRule{\displaywith}, we apply the inductive hypothesis, and from the premises 
			% \begin{align*}
			...
			% \end{align*}
			% now if $ \Delta[\mathV'] = \Delta[\mathV'']$ (the same for $\Phi$), we can write
			% \begin{align*}
			% 	&\async{\Psi}{\Delta[\mathV'']}{\phi_2, \Phi[\mathV'']} \\
			% 	&\async{\Psi}{\Delta[\mathV'']}{\phi_1, \Phi[\mathV'']}
			% \end{align*}
