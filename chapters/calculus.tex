...
\begin{figure}[H]
	\begin{subfigure}{\textwidth}
		\centering
			...
			\\
			\SetCell[c=2]{c} {\footnotesize
			\AXC{$\vdash \Delta, \af{\phi_2}{e} \separator \constr{\Lambda, \used{e}}{\mathV'}$}
			\AXC{$\vdash \Delta, \af{\phi_1}{e} \separator \constr{\Lambda, \used{e}}{\mathV''}$}
			\LeftLabel{$[\llwith]$}
			\BIC{$\vdash \Delta, \af{\phi_1 \llwith \phi_2}{e} \separator \constr{\Lambda}{\mathV''}$}	
			\DP}
			\\
			\SetCell[c=2]{c} {\footnotesize
			\AXC{$\vdash \Delta_L^X, \af{\phi_1}{e} \separator \constr{\Lambda, \used{e}}{\mathV'}$}
			\AXC{$\vdash \Delta_R^X, \af{\phi_2}{e} \separator \constr{\mathV'}{\mathV''}$}
			\LeftLabel{$[\llten]$}
			\BIC{$\vdash \Delta, \af{\phi_1 \llten \phi_2}{e} \separator \constr{\Lambda}{\mathV''}$}	% capisco il movimento dei constraint
			\DP}
			\\ 
			\SetCell[c=2]{c} {\footnotesize
			\AXC{$\new{x}$}
			\AXC{$\vdash \Delta, \af{\phi_1}{x}, \af{\phi_2}{\varNot{x}} \fCenter \separator \constr{\Lambda, \used{e}}{\mathV}$}
			\LeftLabel{$[\llplus]$}
			\BIC{$\vdash \Delta, \af{\phi_1 \llplus \phi_2}{e} \fCenter \separator \constr{\Lambda}{\mathV}$}
			\DP}
			\\
			{\footnotesize
			\AXC{$\sat{ \Lambda, \used{e}, \avail{\Delta}}{\mathV}$}
			\LeftLabel{$[1]$}
			\UIC{$\vdash \Delta, \af{\llone}{e} \separator \constr{\Lambda}{\mathV}$}
			\DP} 
			&
			{\footnotesize
			...
			\LeftLabel{$[A]$}
			\BIC{$\vdash \af{\alpha}{e_1}, \af{\llnot{\alpha}}{e_2}, \Delta \separator \constr{\Lambda}{\mathV}$}
			\DP}
		\end{tblr}
...
$$
	...
	\LeftLabel{$[R\!\Downarrow]$}
	\UIC{$\focus{.}{\af{\llnot{a}}{x_2x_3}, \cancel{\af{\llnot{b}}{x_2x_4}}}{\af{a}{x_1}} \separator \constr{\used{x_1}, \used{x_2}}{x_1 \mapsto \top, x_2 \mapsto \top, x_3 \mapsto \top, x_4 \mapsto \bot}$}
	\AXC{$\sat{\used{x_1}, \used{x_2}, \used{x_2\varNot{x_4}}, \avail{x_2\varNot{x_3}}}{x_1 \mapsto \top, x_2 \mapsto \top, x_3 \mapsto \top, x_4 \mapsto \bot}$}
	\LeftLabel{$[I_1]$}
	\UIC{$\focus{.}{\af{b}{x_1}, \cancel{\af{\llnot{a}}{x_2\varNot{x_3}}}}{\af{\llnot{b}}{x_2\varNot{x_4}}} \separator \constr{\used{x_1}, \used{x_2}}{x_1 \mapsto \top, x_2 \mapsto \top, x_3 \mapsto \top, x_4 \mapsto \bot}$}
	\LeftLabel{$[D_1]$}
	\UIC{$\focus{.}{\af{b}{x_1}, \cancel{\af{\llnot{a}}{x_2\varNot{x_3}}}, \af{\llnot{b}}{x_2\varNot{x_4}}}{.} \separator \constr{\used{x_1}, \used{x_2}}{x_1 \mapsto \top, x_2 \mapsto \top, x_3 \mapsto \top, x_4 \mapsto \bot}$}
	\LeftLabel{$[R\!\Uparrow]$}
	\UIC{$\focus{.}{\cancel{\af{\llnot{a}}{x_2\varNot{x_3}}}, \af{\llnot{b}}{x_2\varNot{x_4}}}{\af{b}{x_1}} \separator \constr{\used{x_1}, \used{x_2}}{x_1 \mapsto \top, x_2 \mapsto \top, x_3 \mapsto \top, x_4 \mapsto \bot}$}
	\LeftLabel{$[R\!\Downarrow]$}
	\UIC{$\focus{.}{\cancel{\af{\llnot{a}}{x_2\varNot{x_3}}}, \af{\llnot{b}}{x_2\varNot{x_4}}}{\af{b}{x_1}} \separator \constr{\used{x_1}, \used{x_2}}{x_1 \mapsto \top, x_2 \mapsto \top, x_3 \mapsto \top, x_4 \mapsto \bot}$}
	\LeftLabel{$[\llten]$}
	\BIC{$\focus{.}{\af{\llnot{a}}{x_2}, \af{\llnot{b}}{x_2}}{\af{a \llten b}{x_1}} \separator \constr{\used{x_1}, \used{x_2}}{x_1 \mapsto \top, x_2 \mapsto \top, x_3 \mapsto \top, x_4 \mapsto \bot}$}
	\LeftLabel{$[D_1]$}
	...
	\LeftLabel{$[\llpar]$}
	\UIC{$\focus{.}{\af{a \llten b}{x_1}}{\af{a \llpar b}{x_2}} \separator \constr{\used{x_1}, \used{x_2}}{x_1 \mapsto \top, x_2 \mapsto \top, x_3 \mapsto \top, x_4 \mapsto \bot}$}
	\LeftLabel{$[R\!\Uparrow]$}
	\UIC{$\focus{.}{.}{\af{a \llten b}{x_1}, \af{a \llpar b}{x_2}} \separator \constr{\used{x_1}, \used{x_2}}{x_1 \mapsto \top, x_2 \mapsto \top, x_3 \mapsto \top, x_4 \mapsto \bot}$}
	\DP
$$
