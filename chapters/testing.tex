...
\begin{tblr}{ colspec = {l l}
	...
	\textbf{notes} & is a human readable text about the test case, e.g. its infix representation; \\
...
These translations introduce a high number of exponentials; this causes -- apart from the timeouts because of the added complexity -- some failures not due to bugs, but because of the the bound.
