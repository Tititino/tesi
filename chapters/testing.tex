...
\begin{center}
\begin{tabular}{l l}
	\textbf{id} &  		\parbox{11cm}{is a number with the sole purpose of tracing back the test case from the output;} \\[7pt]
	\textbf{premises} & 	\parbox{11cm}{is a list of premises as prefix formulae;} \\[7pt]
	\textbf{conclusions} & 	\parbox{11cm}{is a list of conclusions as prefix formulae.} \\[7pt]
\end{tabular}
\end{center}
For example
\begin{minted}{json}
...
\begin{center}
	\begin{tabular}{ l l }
		\textbf{thm} & 		\parbox{11cm}{tells whether this test case is a tautology or not, may be null;} \\[7pt]
		\textbf{*, +, ?, ...} & \parbox{11cm}{is the number of times a specific connective appears in the test case;} \\[7pt]
		\textbf{notes} & 	\parbox{11cm}{is a human readable string about the test case, e.g. its infix representation;} \\[7pt]
		\textbf{size} & 	\parbox{11cm}{is an indicative number of the size of the formula;} \\[7pt]
