...
\begin{frame}{Implementazione}
	...
	\begin{itemize}
		\item<1-> è stata fatta un'implementazione in SWI-Prolog;
		\item<2-> è stato scritto un generatore di test in OCaml;
		\item<3-> è stato architettato un sistema per il testing e il benchmarking in Python.
	\end{itemize}
