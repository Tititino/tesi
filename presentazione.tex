...
\begin{frame}{Theorem prover}
	...
	\begin{enumerate}
		\item si inizia con un singolo \textit{goal}, cioè il sequente iniziale;
		\item si sceglie un nuovo goal;
		\item lo si scompone applicando una regola ``al contrario'' ad una delle formule nel goal;
...
\begin{frame}{Focusing}
	...
	\begin{itemize}
		\item certe sono invertibili e possono essere applicate in qualunque ordine senza perdere completezza (non-determinismo don't-care),
