...
\begin{frame}{Calcolo dei sequenti}
	...
	\begin{itemize}
		\item \onslide<2->{il sequente $\Delta \vdash \Gamma$, che esprime una implicazione tra la congiunzione di $\Delta$ e la disgiunzione di $\Gamma$;}
		\item \onslide<3->{la regola, che descrive come si possono comporre i sequenti, ad esempio
			$$
