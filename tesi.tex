...
\begin{table}
	...
	\begin{tblr}{ 
		...
		\hline
		\hline
		APLL & 0 & 16 & 72 & $\approx 0.80$ & 0.037s & 0.055s \\
		llprover & 20 & 6 & 62 & $\approx 0.70$ & 1.709s & 3.253s \\
		sat-ll & 4 & 18 & 66 & $\approx 0.75$ & 0.130s & 0.185s \\
		\hline
		...
		\hline
		\hline
		APLL & 0 & 17 & 71 & $\approx 0.80$ & 0.035s & 0.326s \\
		llprover & 20 & 6 & 62 & $\approx 0.70$ & 0.981s & 2.179s \\
		sat-ll & 5 & 15 & 68 & $\approx 0.77$ & 0.443s & 0.496s \\
		\hline
	\end{tblr}
\end{table}
