...
\begin{define}[Constraints]
	...
	\begin{align*}
		\used{\Delta} &= \{ \used{e_2} \mid e_2 \in \mathrm{exp}(\Delta) \} \\
		\avail{\Delta} &= \{ \avail{e_2} \mid e_2 \in \mathrm{exp}(\Delta) \}
	\end{align*}
	We denote
	\begin{itemize}
...
\begin{proof}
	...
	\begin{itemize}
		...
		\item[$\llwith$:]
			...
			\DP
			$$
			Or equivalently choosing $\mathV''$.
			This holds because of Lamma \ref{lemma:subsume} and because $\Lambda \subseteq \used{e}, \Lambda$.
			$$
